...
//        Use the remainder and division operators to pick off the binary userInput’s digits one at a time, from
//        right to left. In the decimal userInput system, the rightmost digit has a positional value of 1 and the
//        next digit to the left a positional value of 10, then 100, then 1000, and so on. The decimal userInput
//        234 can be interpreted as 4 * 1 + 3 * 10 + 2 * 100. In the binary userInput system, the rightmost digit
